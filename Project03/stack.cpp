...
{
    return (0 == array || Size() <= 0) || (0 == Capacity());    // conditional if the top-most element of the stack is also the  bottem-most element
}
...
int Stack::Max() const
{
    ...
    int MaxOfStack = -2147483648;                               // stdlib value for minimum integr (header file not allowed to be used)
